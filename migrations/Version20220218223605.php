 ...
 */
final class Version20220218223605 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Prepare for uploading images';
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post DROP updated_at, CHANGE slug slug VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE content content LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE main_image main_image VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE headline headline VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
