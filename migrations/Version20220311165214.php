 ...
 */
final class Version20220311165214 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add "completed_on" variable to "project" table';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE project ADD completed_on DATETIME DEFAULT NULL');
    }
