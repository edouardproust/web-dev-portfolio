 ...
 */
final class Version20220212132100 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add a "featured" option to Project';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE project ADD featured TINYINT(1) DEFAULT NULL');
    }
