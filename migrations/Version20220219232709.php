 ...
 */
final class Version20220219232709 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Improve AdminOptions system';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE admin_option ADD type VARCHAR(255) NOT NULL, ADD help VARCHAR(255) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE admin_option DROP type, DROP help, CHANGE constant constant VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
