 ...
 */
final class Version20220217200405 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Rename Author::approved by Author::isApproved';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE author CHANGE approved is_approved TINYINT(1) DEFAULT NULL');
    }
