 ...
 */
final class Version20220214232147 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Replace "slug" prop name by "constant" for AdminOption entity';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin_option CHANGE slug constant VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin_option ADD slug VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP constant');
