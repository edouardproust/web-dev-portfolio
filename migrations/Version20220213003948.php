 ...
 */
final class Version20220213003948 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add "headline" prop to all content entities';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE lesson ADD headline VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE post ADD headline VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE project CHANGE description headline VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post DROP headline, CHANGE slug slug VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE content content LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE main_image main_image VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
