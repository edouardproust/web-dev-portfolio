 ...
 */
final class Version20220329192050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gallery_item DROP created_at');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gallery_item ADD created_at DATETIME NOT NULL, CHANGE item item VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE caption caption VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
