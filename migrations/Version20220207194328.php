 ...
 */
final class Version20220207194328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE author ADD full_name VARCHAR(255) NOT NULL');
    }
