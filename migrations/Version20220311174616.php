 ...
 */
final class Version20220311174616 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add "gallery" variable to "project" table';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE project ADD gallery JSON DEFAULT NULL');
    }
