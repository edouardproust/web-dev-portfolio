...
function readmore() {
	...
	$elements.each( function(){
		...
		if( elMaskD == 'true' ) {
			elMask.css({ 'height': elMaskSize, 'background-image': 'linear-gradient( '+ HEXtoRGBA( elMaskColor, 0 ) +', '+ HEXtoRGBA( elMaskColor, 1 ) +' )' });
		} else {
